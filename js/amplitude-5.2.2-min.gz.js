!(function (e, t) {
    ...
    q = {
      ...
      _decode: function (e) {
        ...
        for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); u < e.length; )
          (t =
            (q._keyStr.indexOf(e.charAt(u++)) << 2) |
            ((r = q._keyStr.indexOf(e.charAt(u++))) >> 4)),
            (n =
              ((15 & r) << 4) | ((o = q._keyStr.indexOf(e.charAt(u++))) >> 2)),
  ...
  var e,
    ...
    G = function (e) {
      ...
      if (Object.keys(e).length > a)
        return (
          M.error("Error: too many properties (more than 1000), ignoring"), {}
        );
      var n = {};
      for (var i in e)
          ...
          "array" !== s && "object" !== s
            ? "string" === s
              ...
              : ("date" !== s && "number" !== s && "boolean" !== s) ||
                ...
                i.push(o))
            : M.warn("WARNING: Skipping nested " + s + " in array groupName");
        }
        return i;
      }
      M.warn(
    ...
    Q = function e(t) {
      if ("array" === C(t)) for (var n = 0; n < t.length; n++) t[n] = e(t[n]);
      else if ("object" === C(t))
    ...
    te = { expirationDays: void 0, domain: void 0 },
    ne = function (e) {
      var t,
        n,
        i = ((t = e),
        ((n = document.createElement("a")).href = t),
        n.hostname || location.hostname).split("."),
        r = i[i.length - 1],
        o = [];
    ...
    ie = function (e) {
      ...
      return (
        te.domain &&
          (t =
            "." === te.domain.charAt(0) ? te.domain.substring(1) : te.domain),
        e + t
      );
    },
    re = function (e) {
  ...
  if (
    ...
    (ue.style.display = "none"),
      ...
      ue.addBehavior &&
        (ue.addBehavior("#default#userdata"),
        (e = {
          length: 0,
          ...
          clear: function () {
            ...
            for (
              var e, t = 0;
              (e = ue.XMLDocument.documentElement.attributes[t++]);
    ...
    (fe.prototype.clearAll = function () {
      return (
        0 < Object.keys(this.userPropertiesOperations).length
          ? this.userPropertiesOperations.hasOwnProperty(le) ||
            W.error(
              "Need to send $clearAll on its own Identify object without any other operations, skipping $clearAll"
            )
          : (this.userPropertiesOperations[le] = "-"),
        this
      );
    }),
      ...
      !(function (e) {
              ...
              (u = g(
                (u = g(
                      ...
                      (u = h(
                        (u = h(
                          ...
                          (p = h(
                            ...
                            (c = h(
                              c,
                              (a = h(a, u, p, c, e[n + 1], 4, -1530992060)),
                              u,
                              p,
                              e[n + 4],
                              11,
                        ...
                        (p = h(
                          ...
                          (c = h(
                            c,
                            (a = h(a, u, p, c, e[n + 13], 4, 681279174)),
                            u,
                            p,
                            e[n],
                            11,
                  ...
                  (p = g(
                    ...
                    (c = g(
                      c,
                      (a = g(a, u, p, c, e[n + 12], 6, 1700485571)),
                      u,
                      p,
                      e[n + 3],
                      10,
                ...
                (p = g(
                  ...
                  (c = g(
                    c,
                    (a = g(a, u, p, c, e[n + 8], 6, 1873313359)),
                    u,
                    p,
                    e[n + 15],
                    10,
        ...
        function o(e, t) {
          return (function (e, t) {
            ...
            return (
              (i = u(o.concat(c(t)), 512 + 8 * t.length)),
              p(u(s.concat(i), 640))
            );
          })(n(e), n(t));
        }
  ...
  var Ee = function (i, r) {
      !1 ===
        (r = be({ encode: !0, strict: !0, arrayFormat: "none" }, r)).sort &&
        (r.sort = function () {});
      var o = (function (i) {
  ...
  (xe.prototype.setProductId = function (e) {
    return (
      "string" !== C(e)
        ...
        : $(e)
        ? W.error("Invalid empty productId")
        : (this._productId = e),
      this
    );
  }),
    (xe.prototype.setQuantity = function (e) {
      return (
        "number" !== C(e)
          ? W.error(
              "Unsupported type for quantity: " + C(e) + ", expecting number"
            )
    ...
    (xe.prototype.setRevenueType = function (e) {
      return (
        "string" !== C(e)
          ? W.error(
              "Unsupported type for revenueType: " + C(e) + ", expecting string"
            )
          : (this._revenueType = e),
        this
      );
    ...
    (xe.prototype._isValidRevenue = function () {
      return (
        ...
        (W.error("Invalid revenue, need to set price field"), !1)
      );
    }),
    (xe.prototype._toJSONObject = function () {
      var e = "object" === C(this._properties) ? this._properties : {};
      return (
        null !== this._productId && (e[s] = this._productId),
  ...
  var Ne = ge(function (b, I) {
      !(function (r, d) {
        var l = "function",
                ...
                for (n = i = 0; n < p.length && !s; )
                  if ((s = p[n++].exec(e)))
                    for (r = 0; r < c.length; r++)
                      (a = s[++i]),
                        "object" == typeof (o = c[r]) && 0 < o.length
                          ? 2 == o.length
                            ? typeof o[1] == l
          ...
          y = function (e, t) {
            if (
              ("object" == typeof e && ((t = e), (e = d)), !(this instanceof y))
            )
        ...
        (y.VERSION = "0.7.19"),
          (y.BROWSER = { NAME: t, MAJOR: "major", VERSION: o }),
          ...
          (y.ENGINE = { NAME: t, VERSION: o }),
          (y.OS = { NAME: t, VERSION: o }),
    ...
    Ae = function (e) {
      (this._instanceName = $(e) ? f : e.toLowerCase()),
        (this._legacyStorageSuffix =
          this._instanceName === f ? "" : "_" + this._instanceName),
        (this._unsentEvents = []),
        ...
        try {
          ...
          if (
            ((this._apiPropertiesTrackingOptions =
              0 < Object.keys(r).length ? { tracking_options: r } : {}),
  ...
  (Ae.prototype.runQueuedFunctions = function () {
    ...
    (Ae.prototype._loadSavedUnsentEvents = function (e) {
      ...
      return (
        this._removeFromLegacyStorage(ce, e),
  ...
  (Ae.prototype.identify = function (e, t) {
    if (this._apiKeySet("identify()"))
      if (
        ("object" === C(e) && e.hasOwnProperty("_q") && (e = Me(new fe(), e)),
        e instanceof fe)
      ) {
      ...
      if (this._apiKeySet("groupIdentify()"))
        if (H(e, "group_type", "string") && !$(e))
          if (null != t)
            ...
            "function" === C(i) &&
              i(0, "No request sent", { reason: "Invalid group name" });
        else
          "function" === C(i) &&
            i(0, "No request sent", { reason: "Invalid group type" });
      else
        "function" === C(i) &&
          i(0, "No request sent", { reason: "API key is not set" });
    }),
      ...
      if ((je(this), e))
        if (this.options.optOut)
          ...
          try {
            ...
            (!this._sessionId ||
              !this._lastEventTime ||
              c - this._lastEventTime > this.options.sessionTimeout) &&
              (this._sessionId = c),
            ...
            return (
              e === h || e === g
                ? (this._unsentIdentifys.push(d),
                  this._limitEventsQueued(this._unsentIdentifys))
                : (this._unsentEvents.push(d),
    ...
    (Ae.prototype.logEventWithTimestamp = function (e, t, n, i) {
      return this._apiKeySet("logEvent()")
        ? H(e, "eventType", "string")
          ? $(e)
            ? ("function" === C(i) &&
                i(0, "No request sent", { reason: "Missing eventType" }),
              -1)
            : this._logEvent(e, t, null, null, null, null, n, i)
          : ("function" === C(i) &&
              i(0, "No request sent", { reason: "Invalid type for eventType" }),
            -1)
        : ("function" === C(i) &&
            i(0, "No request sent", { reason: "API key not set" }),
          -1);
    }),
    (Ae.prototype.logEventWithGroups = function (e, t, n, i) {
      return this._apiKeySet("logEventWithGroups()")
        ? H(e, "eventType", "string")
          ? this._logEvent(e, t, null, null, n, null, null, i)
          : ("function" === C(i) &&
              i(0, "No request sent", { reason: "Invalid type for eventType" }),
            -1)
        : ("function" === C(i) &&
  ...
  (Ae.prototype.logRevenueV2 = function (e) {
    if (this._apiKeySet("logRevenueV2()"))
      if (
        ("object" === C(e) && e.hasOwnProperty("_q") && (e = Me(new xe(), e)),
        e instanceof xe)
      ) {
    ...
    (Ae.prototype.logRevenue = function (e, t, n) {
      return this._apiKeySet("logRevenue()") && Ge(e) && (void 0 === t || Ge(t))
        ? this._logEvent(
            o,
            {},
            {
  ...
  (Ae.prototype.sendEvents = function (n) {
    if (this._apiKeySet("sendEvents()"))
      if (this.options.optOut)
        "function" === C(n) &&
          n(0, "No request sent", { reason: "optOut is set to true" });
      else if (0 !== this._unsentCount())
        if (this._sending)
          "function" === C(n) &&
            n(0, "No request sent", { reason: "Request already in progress" });
        else {
          this._sending = !0;
          var e =
            ...
            try {
              200 === e && "success" === t
                ? (p.removeEvents(r, o),
                  ...
                  p._sendEventsIfReady(n) || "function" !== C(n) || n(e, t))
                : 413 === e
                ? (1 === p.options.uploadBatchSize && p.removeEvents(r, o),
        ...
        "function" === C(n) &&
          n(0, "No request sent", { reason: "No events to send" });
    else
      "function" === C(n) &&
        n(0, "No request sent", { reason: "API key not set" });
  }),
    (Ae.prototype._mergeEventsAndIdentifys = function (e) {
      for (var t = [], n = 0, i = -1, r = 0, o = -1; t.length < e; ) {
        ...
        a
          ? (i = (s = this._unsentEvents[n++]).event_id)
          : u
          ? (o = (s = this._unsentIdentifys[r++]).event_id)
          : !("sequence_number" in this._unsentEvents[n]) ||
            this._unsentEvents[n].sequence_number <
              this._unsentIdentifys[r].sequence_number
          ? (i = (s = this._unsentEvents[n++]).event_id)
          : (o = (s = this._unsentIdentifys[r++]).event_id),
          t.push(s);
      }
  ...
  var Ke = window.amplitude || {},
    Ve = new Fe();
  for (var We in ((Ve._q = Ke._q || []), Ke._iq))
